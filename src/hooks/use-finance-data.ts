...
export function useFinanceData() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'expenses' | 'budgets' | 'analytics' | 'goals' | 'wellness' | 'learning' | 'insights' | 'predictions' | 'reports' | 'chat' | 'validator' | 'profile'>('overview');
